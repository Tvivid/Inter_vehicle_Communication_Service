...
//    }
    ...
    public void testUpdateIconSetting() {
        ...
        String memberId = "12345";
        String newEmojiId = "emoji_02";
        String newEmojiColor = "#00FF00";

        // 아이콘 설정을 업데이트
        int updatedRows = customizingSettingMapper.updateIconSetting(newEmojiId, newEmojiColor, memberId);
        ...
        Assertions.assertEquals(newEmojiId, updatedSetting.getEmoji_id(), "아이콘 ID가 업데이트되지 않았습니다.");
        Assertions.assertEquals(newEmojiColor, updatedSetting.getEmoji_color(), "아이콘 색상이 업데이트되지 않았습니다.");
    }
}
